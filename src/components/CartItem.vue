<template>
  <div class="flex justify-center border h-fit mx-0 p-2">
    <div class="flex justify-center items-center w-full">
      <!-- {{ cart }} -->
      <img :src="cart?.images[0]" alt="" class="flex items-start h-24 w-auto object-scale-down overflow-hidden" >
      <!-- <img :src="cart?.images[0]" alt="" class="flex items-start h-36 w-auto" > -->
    </div>
